...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2017 at 08:16 AM
...
--
ALTER TABLE `record`
  MODIFY `r_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=375;
--
...
--
ALTER TABLE `student`
  MODIFY `s_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=381;
